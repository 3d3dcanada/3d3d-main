...
export const FLEET: Printer[] = [
  {
    ...
    story: 'Running Klipper with Fluidd and Mainsail. This is the speed demon of the fleet — fast production runs, high throughput, enclosed chamber. The printer that handles the daily queue.',
    type: 'CoreXY',
  ...
  },
  {
    ...
    story: 'Found on Facebook Marketplace for $80. Paid for itself in two days. Compact, reliable, and absurdly capable for its size. The printer that proves you do not need to spend a fortune to produce professional results.',
    type: 'FDM',
  ...
  },
  {
    ...
    name: 'Bibo 2',
    nickname: 'The Dual',
    story: 'Dual extrusion workhorse. When a job needs two materials or soluble supports, this is the machine that handles it. Not the fastest, but the most versatile for complex prints.',
    type: 'FDM',
  ...
  },
  {
    ...
    story: 'The multi-material unit turns this into a 5-color machine. Proven Prusa reliability, open-source firmware, and the kind of dimensional accuracy that engineers trust. The printer for precision jobs and multi-color showpieces.',
    type: 'FDM',
    ...
    status: 'active',
    highlights: [
      'MMU2S — up to 5 colors/materials per print',
  ...
  },
  {
    ...
    story: 'Large format build volume for oversize parts. When a job does not fit on the other machines, this is where it goes. Helmets, enclosure panels, large marine hardware — the printer for projects that need room.',
    type: 'FDM',
...
export const FLEET_STATS = {
  ...
  materialsSupported: [...new Set(FLEET.flatMap((p) => p.materials))].length,
  maxBuildVolume: '420 × 420 × 500 mm',
  allActive: FLEET.every((p) => p.status === 'active'),
};
