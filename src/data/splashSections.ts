...
export const SPLASH_SECTIONS: SplashSection[] = [
  {
    ...
    modelPath: '/models/splash-market.glb',
    modelScale: 12.0,
  ...
  },
  {
    ...
    href: '/quote',
    backgroundImage: '/images/splash-bg-services.png',
    accent: 'teal',
    ...
    modelPath: '/models/splash-services.glb',
    modelScale: 1.6,
  ...
  },
  {
    ...
    modelPath: '/models/splash-network.glb',
    modelScale: 1.1,
  ...
  },
  {
    ...
    href: '/about',
    backgroundImage: '/images/splash-bg-about.png',
    accent: 'magenta',
    ...
    modelPath: '/models/splash-about.glb',
    modelScale: 1.4,
  ...
  },
  {
    ...
    href: '/materials',
    backgroundImage: '/images/splash-bg-materials.png',
    accent: 'orange',
    naturalColors: ['#FF6B2B', '#E5EBED', '#A4A4A4'],
    ariaLabel: 'Materials. View the engineering-grade compounds we use for harsh environments.',
    modelPath: '/models/splash-materials.glb',
    modelScale: 1.0,
    modelRotation: [0.35, 1.2, -0.12],
    modelOffset: [0, -0.08, 0.06],
  },
  {
    id: 'media',
    ...
    href: '/media',
    backgroundImage: '/images/splash-bg-media.png',
    accent: 'magenta',
    naturalColors: ['#E84A8A', '#F5D0E0', '#8A2356'],
    ariaLabel: 'Media. Support content production and view our latest builds.',
    modelPath: '/models/splash-media.glb',
    modelScale: 1.2,
    modelRotation: [-0.18, 0.95, 0.14],
    modelOffset: [0, 0.04, -0.08],
  },
  {
    id: 'faq',
    ...
    href: '/faq',
    backgroundImage: '/images/splash-bg-faq.png',
    accent: 'teal',
    naturalColors: ['#40C4C4', '#D4F0F0', '#2A9D9D'],
    ariaLabel: 'FAQ. Read the guidelines and support policies for 3D3D.',
    modelPath: '/models/splash-faq.glb',
    modelScale: 0.9,
    modelRotation: [0.24, -1.1, -0.08],
    modelOffset: [0, -0.15, 0.04],
  }
];
